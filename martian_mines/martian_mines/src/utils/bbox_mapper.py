...
class BBoxMapper(Node):
    ...
    def get_transform(self, transform_time=Time()):
        try:
    ...
    def bbox_to_ground_position(self, bbox: BoundingBoxLabeled, transform_time=Time()):
        ...
        if transform:
            ...
            self.get_logger().warn("The line is parallel to the plane, cannot get intersection.")
